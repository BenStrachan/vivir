...
class AssessmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment_type" do
    assert_difference('AssessmentType.count') do
      post assessment_types_url, params: { assessment_type: { business_id: @assessment_type.business_id, default_monthly_repeat: @assessment_type.default_monthly_repeat, name: @assessment_type.name } }
    end
  ...
  test "should update assessment_type" do
    patch assessment_type_url(@assessment_type), params: { assessment_type: { business_id: @assessment_type.business_id, default_monthly_repeat: @assessment_type.default_monthly_repeat, name: @assessment_type.name } }
