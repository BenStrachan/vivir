...
class JobTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_type" do
    assert_difference('JobType.count') do
      post job_types_url, params: { job_type: { business_id: @job_type.business_id, default_weekly_visits: @job_type.default_weekly_visits, name: @job_type.name } }
    end
  ...
  test "should update job_type" do
    patch job_type_url(@job_type), params: { job_type: { business_id: @job_type.business_id, default_weekly_visits: @job_type.default_weekly_visits, name: @job_type.name } }
